...
const head = `<svg width="558" height="590" viewBox="0 0 558 590" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
const background = `<svg width="1000" height="1000" viewBox="0 0 1000 1000" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
const sup = `<svg width="764" height="389" viewBox="0 0 764 389" fill="none" xmlns="http://www.w3.org/2000/svg">
<path
...
{
  /* <image
              href={`data:image/svg+xml;utf8,${encodeURIComponent(sup)}`}
              x="0"
              y="0"
              width="100%"
              height="100%"
...
const NewBody = () => {
  return (
    <div>
      ...
      >
        <image
          href={`data:image/svg+xml;utf8,${encodeURIComponent(background)}`}
          x="0"
          y="0"
          width="100%"
          height="100%"
        ...
        <foreignObject x="0" y="0" width="100%" height="100%">
          <div
            ...
            style={{ margin: "0 auto", marginTop: "calc(100% - 389px" }}
          />
        </foreignObject>
        <foreignObject x="0" y="0" width="100%" height="100%">
          <div
            dangerouslySetInnerHTML={{ __html: head }}
            style={{ margin: "0 auto", marginTop: "140px" }}
          />
        </foreignObject>
      </svg>
    </div>
