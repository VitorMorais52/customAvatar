...
const Four = ({ translateValues }) => {
  const x = translateValues?.x ? translateValues.x : "24";
  const y = translateValues?.y ? translateValues.y : "12";
  return (
    <g className="hairComponent" transform="scale(0.1) translate(-220,-60)">
      <path
